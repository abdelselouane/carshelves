...
<div class="container">
	<div class="row">
    	...
    	<div class="col-sm-2"><a href="/users" class="pull-right"><img title="profile image" class="img-circle img-responsive" src="<?= base_url()."images/profile-placeholder.png"?>"></a></div>
    </div>
    <div class="row">
    	...
    	<div class="col-sm-9">
          ...
          <ul class="nav nav-tabs" id="myTab">
            <li class="active"><a href="#myads" data-toggle="tab">My ADs</a></li>
            <li><a href="#favorites" data-toggle="tab">My Favorites</a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="myads">
              ...
              <div class="tab-pane" id="favorites">
               ...
               <ul class="list-group">
                  <li class="list-group-item text-muted">Favotites Ads</li>
